...
- Social artwork download: lightbox **Download** saves the image file (blob + download attribute); Preview phone corner download control removed in favor of gradient **Edit Artwork** hover CTA; enlarge lightbox portals above the app header so it is not cropped — **shipped**
- Social Preview phone **Edit Artwork**: gradient icon-only control expands on hover/focus to “Edit Artwork” with animated gradient movement — **shipped**
