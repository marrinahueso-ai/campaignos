...
- Approvals **Request changes** (approver): same dimmed pop-out feel as open review — note + tags (Artwork · Stories · Date · Caption · Copy); forest **Send change request** + Cancel; **← Back to review** reopens open view; full-page `/approvals/revision?mode=approver` remains for deep links — **shipped**
