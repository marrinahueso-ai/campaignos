...
**Status:** Living  
**Owner:** Product / QA  
**Last updated:** August 19, 2026 — Customer AI Brain + Canva UI unshipped for launch  
...
| Settings Ease Phases 1–7 + Branding hub | **Done** | Overview → Account; Branding nests school year + Inbox / Communication Plans / Colors (AI Brain customer UI unshipped; `/settings/ai-brain` → Branding). Canva connect UI unshipped; `/settings/canva` → Integrations |
