import { FACEBOOK_URL, INSTAGRAM_URL } from "@/lib/marketing/social-links";
import { cn } from "@/lib/utils/cn";

interface MarketingSocialLinksProps {
  className?: string;
}
...
const linkClassName =
  "inline-flex h-8 w-8 items-center justify-center rounded-full text-cos-muted transition-colors hover:text-cos-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cos-accent/40";

export function MarketingSocialLinks({ className }: MarketingSocialLinksProps) {
  return (
