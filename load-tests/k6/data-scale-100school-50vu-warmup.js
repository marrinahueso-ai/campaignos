/**
 * Discardable warm-up ahead of data-scale-100school-50vu. Small pinned
 ...
 * 50-VU run with a new TEST_RUN_ID.
 *
...
import {
  DATA_SCALE_100SCHOOL_50VU_WARMUP_WORKLOAD,
...
export const options = {
  scenarios: {
    data_scale_100school_50vu_warmup: DATA_SCALE_100SCHOOL_50VU_WARMUP_WORKLOAD,
  },
  // Soft: warm-up must not fail the program if a cold Preview hiccups once.
  // Hard gates belong on the recorded 50-VU profile only.
  thresholds: {
    ...buildDataScale100School50VuThresholds(),
...
export function setup() {
  ...
  console.log(
    `[data-scale-100school-50vu-warmup] BASE_URL=${data.baseUrl} TEST_RUN_ID=${data.testRunId} ` +
...
export function handleSummary(data) {
  ...
  return {
    ...
    [`load-tests/k6/results/data-scale-100school-50vu-warmup-${safeRunId}-summary.json`]:
