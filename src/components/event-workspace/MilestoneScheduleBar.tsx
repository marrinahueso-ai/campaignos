...
export interface MilestoneScheduleBarProps {
...
export function MilestoneScheduleBar({
  milestones,
  selectedRelativeDay,
  onSelectMilestone,
  scheduledFor,
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-3 border-b border-cos-border bg-cos-bg/80 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between sm:px-5",
        className,
      )}
    >
