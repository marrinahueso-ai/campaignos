                ...
                <div className="mb-0.5 flex items-center gap-0.5 text-xs">
                  {positive ? (
                    <ArrowUpRight
                      className={cn(
                        "h-3.5 w-3.5",
                        selected ? "text-emerald-300" : "text-cos-success",
                      )}
                    />
                  ) : (
                    <ArrowDownRight
                      className={cn(
                        "h-3.5 w-3.5",
                        selected ? "text-red-300" : "text-cos-error",
                      )}
                    />
                  )}
                  <span
        ...
        if (interactive) {
          return (
            <button
              ...
              className={cn(
                "min-h-[7.5rem] rounded-2xl px-4 py-4 text-left transition-all duration-200",
                selected
