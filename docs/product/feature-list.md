...
- AI credits engine — **shipped** (Phases 1–6: metering, widget, Owner monitor/grants, billing catalog, Stripe Checkout/Portal/webhooks, 14-day trial + 600 credits, feature/capacity gates, hard-block AI when period + Reserve cannot cover the action — living: [billing-and-access.md](../ops/billing-and-access.md) · [ai-and-apis.md](./ai-and-apis.md))
