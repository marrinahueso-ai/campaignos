...
**Last updated:** July 31, 2026 — Flyer Print: generated PNG opens letter-only print doc (Safari)
...
- **Save by month** (work ahead on next month’s homepage) — **mockup** only: [`public/homepage-composer-month-ease-mockup.html`](../../public/homepage-composer-month-ease-mockup.html) (month workspace · Save this month · Copy from prior month; not production persistence yet)
