      ...
      <tr className="border-b border-cos-border/70 align-middle">
        <td className="py-4 pr-3">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cos-accent-soft text-xs font-semibold text-cos-dark">
              {eventInitials(event.title)}
            </span>
        ...
        <td className="py-4 pr-3">
          <div className="min-w-[7rem]">
            ...
            <div className="mt-1.5 h-1.5 overflow-hidden rounded-full bg-cos-bg-alt">
              <div
                className="h-full rounded-full bg-cos-dark"
