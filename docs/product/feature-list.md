...
- Social **Creative Setup** (UX Pilot–aligned): three numbered cards — **1 Campaign & Plan** (event · date bound to the selected event, posts re-dated when the event date changes · communication plan + milestone list kept in sync with plan step count · Use Last Year's Plan soon) · **2 Look & Feel** (brand logos · inspiration images) · **3 Voice & Colors** · sticky **Live Vibe Preview** phone · **Create with AI** / Save Draft / Report a Problem (+ top **Save → Preview**) — **shipped**
