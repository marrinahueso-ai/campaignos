...
- Approvals Ease hub (UX Pilot): forest **Needs you** pulse + Assigned to me / search · **Waiting on your review** focus card (Open full view) · **Also waiting** table (thumb · campaign · post · status · assignee · eye View) · italic **How approvals work** guide; `?review=` deep-link reopens open view — **shipped**
...
- Approvals **Request changes** (approver revision): note + tags (Artwork · Stories · Date · Caption · Copy); forest **Send change request** + Cancel; **← Back to review** (reopens open view); no Approve on this screen; no Newsletter/Homepage footnote — **shipped**
