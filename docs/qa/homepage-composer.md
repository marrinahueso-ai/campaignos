...
|------|-------|------------|
| 1 | **Header** | Title, message, two CTAs, announcements (emoji + text), header colors |
...
| 4 | **Preview** | Full-page preview; **full month** (all cards) or date scrubber for on/off visibility |
| 5 | **Export** | Copy / download full-page Membership Toolkit HTML |
...
- Full-month + date-slider preview; export HTML includes show/hide script for `data-starts` / `data-expires`
...
14. Signed-in org with events: event picker populated. No events: can still add custom cards and export.
15. Signed out / no org: AI generate and artwork upload fail with clear sign-in messaging (draft may still use local key).
