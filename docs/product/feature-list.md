...
- Social artwork download: lightbox **Download** saves the image file (blob + download attribute); Preview phone corner download control removed in favor of gradient **Edit Artwork** hover CTA — **shipped**
