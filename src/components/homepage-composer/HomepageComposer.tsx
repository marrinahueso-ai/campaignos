              ...
              <div className="overflow-hidden rounded-[22px] border border-cos-border bg-cos-card shadow-[0_8px_28px_rgba(28,36,48,0.06)]">
                ...
                >
                  ...
                  {(state.header.button1Label.trim() ||
                    ...
                    state.header.button3Label.trim()) && (
              ...
              >
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <Field
                    ...
                    value={state.header.button3Label}
                    onChange={(v) =>
                      setState((p) => ({
                        ...p,
                        header: { ...p.header, button3Label: v },
                      }))
                    }
                  ...
                  <Field
                    label="Button 3 URL"
                    value={state.header.button3Url}
                    onChange={(v) =>
                      setState((p) => ({
                        ...p,
                        header: { ...p.header, button3Url: v },
                      }))
                    }
                  />
                </div>
                ...
                {state.header.announcements.length === 0 ? (
                  ...
                  <div className="space-y-2 overflow-visible">
                    {state.header.announcements.map((announcement) => (
                      <div
                        key={announcement.id}
                        className="flex flex-wrap items-end gap-1.5 overflow-visible"
                      >
                        ...
                        <DatePopoverField
                          compact
                          className="mb-0.5 w-[8.5rem] shrink-0"
                          label="On"
                          ...
                          <div className="grid grid-cols-[24px_72px_minmax(0,1fr)] items-start gap-3 overflow-visible">
                            ...
                            <div className="min-w-0 space-y-2 overflow-visible">
                              ...
                              <div className="grid gap-2 overflow-visible rounded-[12px] bg-cos-bg-alt/80 p-2 sm:grid-cols-[auto_minmax(0,1fr)_minmax(0,1fr)]">
                                ...
                                <div className="grid gap-2 overflow-visible sm:col-span-2 sm:grid-cols-2">
                                  <DatePopoverField
                                    label="On date"
