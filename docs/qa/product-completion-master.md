...
**Last updated:** August 19, 2026 — Branding Inbox/Plan tabs open shipped pages; Colors & Logos logo thumbs; AI Brain + Canva customer UI unshipped
...
| [x]  | Canva connection                        | Unshipped   | Customer UI **removed** for launch (`/settings/canva` → Integrations). OAuth + import actions stay in repo.                                                                                                                                                     |
...
| [ ]  | Connected Accounts            | Wired   | Settings Overview → **Connected** shows Facebook & Instagram and Google Calendar with a link to manage connections; Canva hidden for launch; not duplicated as a Dashboard tile                                                                                                                                               |
...
| [x]  | Communication Plans                     | Wired    | Library + assign by event type; Settings Branding → Communication Plan opens `/settings/playbooks-milestones` (day-to-day use; template productization deferred above)                                                                                                                                                              |
...
| [x]  | Chooser landing              | Wired       | `/create-with-ai` — **Start here** Social · Flyer (equal two-up); quieter **Also available**: Homepage · Volunteer page · Newsletter                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [ ]  | AI Brain (org voice / style) | Unshipped   | Customer UI **removed** for launch (`/settings/ai-brain` → Branding). Empty org profile → generic Create with AI tone. Training Library not shipped.                                                                                                                                                                                                                                                                                                                                                                                       |
| [x]  | AI Inbox sources             | Wired       | Settings → Branding → AI Inbox opens `/settings/inbox-ai` (manage sources)                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| [x]  | Event Files tab            | Wired   | Phase 3 `?tab=files` — type pills, auto-file note, generated post graphics (read-only), optional folders, multi-file drop/picker, upload/open |
...
| [x]  | Branding hub                                                | Wired   | School year, Inbox, Communication Plans, Colors & Logos (AI Brain tile unshipped). Inbox / Communication Plan tabs open manage-sources and the library directly (no extra landing). Colors & Logos shows PTO/school logo thumbs when uploaded                                                                                                  |
| [x]  | Team & Access                                               | Wired   |                                                                                                                                                                                                                                                                                                                                              |
| [x]  | Integrations                                                | Wired   | Meta, Google Calendar (Canva customer UI unshipped for launch; OAuth remains)                                                                                                                                                                                                 |
...
| [x]  | Canva                | Unshipped | Customer UI hidden for launch; OAuth remains        |
...
| [ ]  | Perf budget (≤2s)     | Partial | Playwright wall-clock suite still needs a production concurrent re-baseline (July 29 local 5× dashboard 6.0–6.1s). **Multi-tenant k6 Performance Engineering Phase 1 is COMPLETE:** 50 VU pass (~1.38s); 75 VU on Medium near-miss (1.55s); correctness perfect 20→75; staging/preferred prod compute **Medium**; do not run 100 VU for Phase 1 close. Handoff: [performance-engineering-phase1-complete.md](./performance-engineering-phase1-complete.md). Playwright ≤2s remains Partial. See also [performance-budget.md](./performance-budget.md#multi-tenant-readiness-k6). |
...
| [x]  | Canva           | Unshipped | OAuth in repo; customer Connect/Import UI hidden                                                                                     |
...
| Can they connect their accounts (Meta / Calendar as needed)?      | [ ] Meta gated App Review; Google **Needs you** G; Canva not a launch connect option            |
